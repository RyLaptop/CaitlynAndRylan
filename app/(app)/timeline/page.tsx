  ...
  return (
    <div className="px-4 pt-6 max-w-lg mx-auto">
      <div className="text-center mb-6">
        <h1 className="font-hand text-4xl text-blush-dark font-bold">Our Story 📅</h1>
        <p className="text-sm text-gray-500 font-sans mt-1">every milestone, forever saved</p>
      </div>

      <form action={addMilestone} className="tape bg-white rounded-3xl shadow-lg p-5 mb-8 mt-4">
        ...
        <div className="flex flex-col gap-6">
          {events?.map((ev: any) => (
            <div key={ev.id} className="flex gap-4 relative">
              ...
              <div className="tape bg-white rounded-3xl p-4 shadow-sm flex-1 mt-1">
          ...
          {!events?.length && (
            <div className="text-center py-12 text-gray-300">
              ...
              <p className="font-sans text-sm mt-2">Add your first milestone!</p>
            </div>
          )}
        </div>
      </div>
